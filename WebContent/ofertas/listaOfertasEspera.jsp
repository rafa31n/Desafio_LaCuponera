...
#admin {
		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<div class="container-fluid">
					<h2>Ofertas en espera de aprobación</h2>
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<tbody>
							<c:forEach items="${requestScope.listaOfertasEspera}"
								var="ofertas">
								<tr>
									...
									<td id="admin"><a class="btn btn-primary"
										...
										href="javascript:eliminar('${ofertas.idOferta}')"></span>
											Eliminar</a></td>
								</tr>
							</c:forEach>
						</tbody>
	...
	<script>
		...
		function eliminar(id) {
			if (confirm("¿Realmente decea eliminar esta oferta?")) {
