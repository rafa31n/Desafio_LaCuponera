							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="nombre"
										id="nombre" value="${rubros.nombreRubro}" required>
								</div>
							</div>
							
							<div class="form-group">

								<label for="id">ID de Rubro</label>
								<div class="input-group">
									<input type="text" class="form-control" name="id"
										id="id" value="${rubros.idRubro}" readonly>
								</div>
							</div>

							<input type="submit" class="btn btn-info" value="Guardar"
								name="Guardar"> <a class="btn btn-danger"
								href="${pageContext.request.contextPath}/rubros.do?op=listar">Cancelar</a>
						</form>
					</div>
				</div>
